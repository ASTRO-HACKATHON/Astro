            ...
            <!-- class="bmenu" -->
                <ul >
                    ...
                    <li><a href="<%=basePath %>organizations/SelItems.jsp">Events</a></li>
                     ...
                     <li><a href="<%=basePath %>Empdashboard.jsp">Employee Dashboard</a></li>
                     <li><a href="<%=basePath %>Adhoc.jsp">Adhoc request Dashboard</a></li>
                     <li><a href="<%=basePath %>Expense.jsp">Expense report</a></li>
